...
export const toggleMemberStatus = (token, id, isActive) => sendJSON(`/api/admin/members/${id}/status`, 'PATCH', { is_active: isActive }, token)
export const deleteMember = (token, id) => sendJSON(`/api/admin/members/${id}/status`, 'DELETE', {}, token)
